...
if __name__ == '__main__':
    ...
    plot(full_mesh, interactive = True)                           # Why does is say unitsquare mesh in plot title ? 
    ...
    plot(active_cells, interactive = True)   		          # <MeshFunction of topological dimension 2 containing 800 values>
    ...
    print'The time it took', timer.stop()                                      # clock how long that took 
    print edge_f.array()               
